...
- template: detail-content
  block: text-1
  headline: '<style>@media (min-width:320px) {.centered-image {width:70%;    margin-left:
    auto;   margin-right: auto; }}</style><h2 style="float: center;">Metodología de
    enseñanza</h2><br><br><br><img class="centered-image" src="/uploads/2021/04/11/marcel_orig.png"
    alt="teacher">'
  content: |-
