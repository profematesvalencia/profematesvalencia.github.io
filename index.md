...
- template: hero-banner-w-image
  block: hero-2
  slug: features
  headline: "<style> .block-hero-2 h1 {color: #FF3333; background-color: rgba(198,198,198,.6);
    padding: 100px 50px 100px 50px; align: right;} h1 span.light {font-weight: 500;
