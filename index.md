...
- template: hero-banner-w-image
  block: hero-2
  slug: features
  headline: "<style> .block-hero-2 h1 {color: #FF3333; background-color: rgba(184,
    184, 184,.7); padding: 100px 50px 100px 50px; align: right;} h1 span.light {font-weight:
    500; }</style>Instrúyete el día de hoy para que seas parte del mañana"
  content: ''
  cta:
    enabled: false
    url: ''
