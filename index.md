...
- template: 1-column-text
  ...
  content: ''
  slug: ''
  headline: '<style>.responsive-iframe-container {     position: relative;     padding-top:
    30px;     height: 0;     overflow: auto; }   .responsive-iframe-container iframe,   .vresponsive-iframe-container
