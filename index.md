...
- template: content-feature
  ...
  headline: "<p>Soy ingeniero industrial e ingeniero en aviación comercial de la Universidad
    ...
    la Universitat de València.</p><pre><code>&lt;style&gt;@media (max-width: 320px)
    {.Iam {padding: 2em -1em;}}@media (min-width: 321px) and (max-width: 375px) {.Iam
    {padding: 2em 0.75em;}}@media (min-width: 376px) and (max-width: 425px) {.Iam
    {padding: 2em 1em;}}@media (min-width: 426px) and (max-width: 768px) {.Iam {padding:
    2em 1.5em;}}@media (min-width: 769px) and (max-width: 1024px)  {.Iam {padding:
    1em 5em;}}@media (min-width: 1025px)  {.Iam {padding: 1em 5em;}}&lt;/style&gt;</code></pre><p>En
    este año 2021 daré comienzo a un doctorado en optimización y estadística que ofrece
